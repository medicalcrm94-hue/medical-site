        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Leading healthcare diagnostics with state-of-the-art technology
            ...
            {[
              {
                ...
                title: "NABL-Grade Equipment",
                desc: "Certified labs with advanced technology and quality assurance",
              },
              {
                icon: <MapPin className="w-12 h-12 text-green-600" />,
                title: "Home Sample Collection",
                desc: "Convenient at-home service with trained phlebotomists",
              },
              {
                icon: <Clock className="w-12 h-12 text-orange-600" />,
                title: "Timely Report Delivery",
                desc: "Fast and accurate results delivered within 24-48 hours",
              },
              {
                icon: <Award className="w-12 h-12 text-purple-600" />,
                title: "Trusted by Doctors",
                desc: "Recommended by 500+ healthcare professionals",
              },
            ].map((item, index) => (
              <div
                key={index}
      ...
      <section id="tests" className="py-20 px-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive health packages designed for your wellness journey
            </p>
          </div>
