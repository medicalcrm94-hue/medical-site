            ...
            <div className="lg:w-2/3">
              ...
              >
                <iframe
                  ...
                  allowFullScreen=""
                  loading="lazy"
                  title="Our Lab Location in Hyderabad"
                  aria-label="Map showing our lab location at 123 Medical Street, Hyderabad"
                ></iframe>
                <div className="p-4 md:p-6">
                  ...
                  <p className="text-gray-600">
                    123 Medical Street, Hyderabad - easily accessible with
                    parking available.
                  </p>
                </div>
              </section>
