                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Each valid medicine gives you points (1 tablet = 1
                        point)
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                  ...
                  NGO partners who work directly with underserved communities.
                  By participating in our Medicine Exchange Drive, you're not
                  just getting great value - you're helping ensure that safe,
                  unused medicines reach those who need them most.
                </p>
                <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                  Every medicine you donate has the potential to improve
                  someone's health and well-being. Together, we're creating a
                  sustainable cycle of care and compassion.
                </p>
