    ...
    <ProtectedRoute>
      <div className="font-sans text-gray-800">
        ...
        <section className="relative bg-blue-600 opacity-95 text-white py-16 sm:py-20 md:py-28 px-4 sm:px-8 md:px-12 lg:px-20">
          ...
          <div className="container mx-auto py-12 sm:py-16 md:py-20 px-4 sm:px-6 relative z-10 text-start">
        ...
        {/* Search Bar */}
        <section className="py-6 sm:py-8 bg-white px-4 sm:px-8 md:px-12 lg:px-20">
                    ...
                    <ul className="space-y-2">
                      {category.tests.map((test, testIndex) => (
                        <li key={testIndex} className="flex items-start">
                          <span className="text-blue-600 mr-2 text-sm sm:text-base">
                            •
                          </span>
        ...
        {/* Service Highlights */}
        <section className="py-12 sm:py-16 bg-white px-4 sm:px-8 md:px-12 lg:px-20">
          <div className="container mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-center text-blue-900 mb-8 sm:mb-12">
              Our Services
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {services.map((service, index) => (
                <div
                  key={index}
                  className="bg-blue-50 p-4 sm:p-6 rounded-lg border border-blue-100 hover:shadow-md transition"
                >
        ...
        {/* Book a Test CTA */}
        <section className="py-12 sm:py-16 bg-blue-900 mb-12 sm:mb-20 text-white px-4 sm:px-8 md:px-12 lg:px-20">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="max-w-4xl mx-auto bg-blue-800 rounded-xl p-6 sm:p-8 md:p-12 text-center">
              ...
              <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 leading-relaxed">
                Our certified team is ready to serve you with accurate
                diagnostics and compassionate care.
              </p>
              <Link href="/book#second-section">
                <button className="bg-white text-blue-900 px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-blue-100 transition w-full sm:w-auto text-sm sm:text-base">
                  Book a Appointment
                </button>
              </Link>
            </div>
